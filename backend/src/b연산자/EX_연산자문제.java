				...
				*/
				...
				금액 = scanner.nextInt();	 // 입력받은 데이터를 정수형으로 가져와서 변수에 대입 
				 ...
				 //문제3 : 하나의 정수를 입력받아 7의 배수 이면 '맞다' 아니면 '아니다' [ if x ]
					System.out.println("문제3)7배수찾기:");
				 	int 문제3 = scanner.nextInt()	;
				 	String 결과3 = 문제3 % 7 == 0 ? "true" : "false";
				  ...
				  //문제4 : 하나의 정수를 입력받아 홀수이면 이면 '홀수' 아니면 '짝수' [ if x ]
				 	...
				 	System.out.println("문제4) 결과 : " + 결과4);
				  //문제5 : 하나의 정수를 입력받아 7의 배수 이면서 짝수 이면 '참' 아니면 '거짓' 
				 	System.out.println("문제6) 7배수 참거짓 : ");
				 	int 문제5 = scanner.nextInt();
				 	String 결과5 = (문제5 % 7 == 0 && 문제5 % 2 == 0)?"참" : "거짓";
				 	System.out.println("결과5) : " + 결과5);
				 // 문제6 : 두개의 정수를 입력받아 더 큰수 출력
				 	System.out.println("문제6) 큰 수 찾기 : ");		int 문제6 = scanner.nextInt();
				 	System.out.println("문제6_1) 큰 수 찾기 : ");	int 문제6_1 = scanner.nextInt();
				 	System.out.println("결과6) : " + (문제6 > 문제6_1 ? 문제6 : 문제6_1));
				 	
				  // 문제7 : 반지름을 입력받아 원 넓이 출력하기 
				 		// 원 넓이 공식 = 반지름 * 반지름 * 원주율[3.14]
				 	System.out.println("문제7) : ");	double 문제7 = scanner.nextDouble();
				 	double 결과7 = 문제7 * 문제7 * 3.14;
				 	System.out.println("문제7) : " + 결과7);
				  //문제8 : 두 실수를 입력받아 앞실수의 값이 뒤의 값의 몇 %인지 출력하기 
				 		// 예) 54.5     84.3  입력했으면    64.285714% 출력 
				 	System.out.println("문제8숫자비교) 실수1 : ");	double 문제8 = scanner.nextDouble();
				 	System.out.println("문제8_) 실수1_1 : ");		double 문제8_1 = scanner.nextDouble();
				 ...
				 // 문제11 : 키와 몸무게를 입력받아 BMI 출력하기
				 	...
				 	System.out.println("문제11) 키 : ");	double 키1 = scanner.nextDouble();
				 	System.out.printf("결과 : %.2f\n" , ((키1/100)*(키1/100)));
				 ...
				 //문제13 :  중간고사, 기말고사, 수행평가를 입력받아 반영비율별 계산하기
							...
							//기말고사 반영비율 => 30 %
							//수행평가 반영비율 => 40 %
				 	System.out.println("문제13)중간고사 : ");	double 중간고사 = scanner.nextInt() * 0.3;
				 	System.out.println("문제13)기말고사 : ");	double 기말고사 = scanner.nextInt() * 0.3;
				 	System.out.println("문제13)수행평가 : ");	double 수행평가 = scanner.nextInt() * 0.3;
				 	System.out.printf("결과 : %f" , (중간고사+기말고사+수행평가));
				 	//%f 실수 -> .x를 넣으면 입력한 값까지 소수점이 나옴
